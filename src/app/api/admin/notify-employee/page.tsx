...
export async function POST(req: Request) {
  try {
    ...
    try {
      await sendMail({
        to: employee.email,
        subject: "Workday Reminder: Come Online and Take Attendance",
        html: `
          <div style="font-family: Arial, sans-serif; background:#f4f4f4; padding:30px;">
            <div style="max-width:620px; margin:auto; background:#ffffff; border-radius:14px; overflow:hidden;">
              <div style="background:#000000; color:#ffffff; padding:28px; text-align:center;">
                <h1 style="margin:0; font-size:24px;">Workday Reminder</h1>
              ...
              <div style="padding:28px; color:#222;">
                ...
                <p style="font-size:15px; line-height:1.7;">
                  This is a friendly reminder that your scheduled work time has started.
                  Please come online, log in to your employee dashboard, and take your attendance as soon as possible.
                </p>

                <div style="background:#f8f8f8; border:1px solid #eeeeee; padding:18px; border-radius:10px; margin:24px 0;">
                  <p style="margin:0 0 10px; font-size:15px;">
                    <strong>Account Email:</strong> ${employee.email}
                  </p>
                  <p style="margin:0 0 10px; font-size:15px;">
                    <strong>Job Title:</strong> ${employee.job_title || "Not provided"}
                  </p>
                  <p style="margin:0; font-size:15px;">
                    <strong>Required Action:</strong> Log in and take attendance
                  </p>
                </div>
                ...
                <p style="margin-top:24px; font-size:14px; color:#666; line-height:1.6;">
                  If you are already online or have already taken attendance, you may disregard this reminder.
                </p>
