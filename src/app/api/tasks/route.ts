...
const { data: employee } = await supabase
  ...
  if (employee?.email) {
    try {
      await sendMail({
        to: employee.email,
        subject: "New Task Assigned - Errandly247 Dashboard",
        html: `
            ...
            <div style="max-width:620px; margin:auto; background:#fff; border-radius:14px; overflow:hidden;">
              ...
              <div style="padding:28px; color:#222;">
                ...
                <p style="font-size:15px; line-height:1.7;">
                  A new task has been assigned to you. Please log in to your dashboard,
                  review the task details, and accept it to begin work.
                </p>

                <div style="background:#f8f8f8; border:1px solid #eee; padding:18px; border-radius:10px; margin:24px 0;">
                  <p style="margin:0 0 10px;"><strong>Task Title:</strong> ${title}</p>
