        ...
        <div className="w-full grid lg:grid-cols-3 gap-6 md:grid-cols-2 grid-cols-1 items-center justify-center rounded-2xl m-auto">
          {logistics.map((logis) => (
            ...
            >
              ...
              <div className="flex flex-col items-start justify-center rounded-b-2xl border border-t-0 border-gray-700 md:px-10 px-5 xl:h-[190px] lg:h-[200px] md:h-[300px] h-[150px] gap-2 w-full">
